  ...
  const Categories = () => {
    ...
    return (
      <div className="p-5">
        <h1 className="text-[40px] font-bold flex justify-center text-center ">Categories<br />Travel</h1>
    ...
    <div className="flex flex-col gap-4">
      <div className="group relative overflow-hidden rounded-lg bg-gray-100 shadow-lg">
        ...
        <div className="p-4">
          ...
          <ul className="flex p-6 gap-4">
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">Trips</li>
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">{categories[1].name}</li>
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">Tours</li>
        </ul>
        </div>
      </div>
      <div className="group relative overflow-hidden rounded-lg bg-gray-100 shadow-lg">
        ...
        <div className="p-4">
          ...
          <ul className="flex p-6 gap-4">
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">Trips</li>
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">{categories[2].name}</li>
          <li className="bg-gray-300 bg-opacity-70 rounded-full p-2 w-auto text-center">Tours</li>
        </ul>
        </div>
      </div>
